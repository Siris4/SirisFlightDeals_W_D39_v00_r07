...
from data_manager_W_D39_v00_r07 import DataManager
from flight_search_W_D39_v00_r07 import FlightSearch
...
for row in sheet_data:
    ...
    if row.get("iataCode") == "":
        print(f"iataCode data is empty for {row['city']}, updating...")
        ...
        print(f"iataCode for {row['city']} is already set to {row['iataCode']}, skipping...")

print("\nSheet Data after potential updates: ")
pprint(sheet_data)
